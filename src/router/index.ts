    ...
    children: [
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "requisition" */ '../views/Requisition/index.vue'
          ),
      },
      {
        path: '/home',
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "list-item" */ '../views/TreeViewDetail/index.vue'
          ),
      },
      {
        path: '/vuex-class',
        ...
        component: () =>
          import(
            /* webpackChunkName: "vuex-class" */ '../components/Person.vue'
          ),
      },
      {
        path: '/hello-world',
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "user-name" */ '@/views/UserName/index.vue'
          ),
      },
      {
        path: '/quantity',
        ...
        component: () =>
          import(
            /* webpackChunkName: "quantity" */ '@/views/Quantity/index.vue'
          ),
      },
      {
        path: '/loading',
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "emit-on" */ '@/views/EventEmitOn/index.vue'
          ),
      },
      {
        path: '/router-test',
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "v-alert" */ '@/views/V-Avatar/index.vue'
          ),
      },
      {
        path: '/summary',
        ...
        component: () =>
          import(
            /* webpackChunkName: "Summary" */ '@/views/CardSummary/index.vue'
          ),
      },
      {
        path: '/card-enums',
        ...
        component: () =>
          import(
            /* webpackChunkName: "CardEnums" */ '@/views/CardTypes/index.vue'
          ),
      },
      {
        path: '/upload',
      ...
      // test for FWC
      {
        ...
        name: 'VDrawer',
        component: () =>
          import(/* webpackChunkName: "VDrawer" */ '@/views/Drawer/index.vue'),
      },
      {
        path: '/vue-extends',
        name: 'Vue-Extends',
        component: () =>
          import(
            /* webpackChunkName: "vue-extends" */ '@/views/VueExtends/index.vue'
          ),
      },
      {
        path: '/vue-jest',
        name: 'Vue-jest',
        component: () =>
          import(/* webpackChunkName: "Vue-jest" */ '@/views/Jest/index.vue'),
      },
      {
        path: '/text-slot',
        name: 'text-slot',
        component: () =>
          import(
            /* webpackChunkName: "text-slot" */ '@/views/TextSlot/index.vue'
          ),
      },
      {
        path: '/lodash',
        name: 'lodash',
        component: () =>
          import(/* webpackChunkName: "lodash" */ '@/views/Lodash/index.vue'),
      },
    ],
  },
    ...
    children: [
      {
        ...
        name: 'Login',
        component: () =>
          import(/* webpackChunkName: "VDialog" */ '@/views/Login/index.vue'),
      },
    ],
  },
]
